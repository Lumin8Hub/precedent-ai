    ...
    >
      <div className="max-w-md text-center">
        <h1
          ...
          style={{ color: palette.navy, fontFamily: "'Cormorant Garamond', serif" }}
        >
          404
        </h1>
        <h2 className="mt-4 text-xl font-semibold" style={{ color: palette.navy }}>
          Page not found
        </h2>
        ...
        <div className="mt-6">
          <Link
            ...
            style={{ backgroundColor: palette.navy, color: palette.parchment }}
          >
            Go home
          </Link>
        </div>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    ...
    >
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold" style={{ color: palette.navy }}>
  ...
  head: () => ({
    meta: [
      { title: "Precedent AI · Legal AI Implementation for Ontario Law Firms" },
      {
        name: "description",
        content:
          "Precedent AI helps Ontario law firms identify the right AI use cases, select the right tools, build governance, train teams, and launch measurable AI workflows — without compromising confidentiality, privilege, or professional responsibility.",
      },
